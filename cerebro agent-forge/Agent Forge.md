...
- [[Kairos, bot de trading (prueba)]] — fallo real del propio SDK
  ("autocompact is thrashing"), no del código de Agent Forge; el aviso de
  retomada que nunca llegaba a la fase, y dos arreglos que no lo resolvieron
