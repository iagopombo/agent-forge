...
`cd` primero. Los bloqueos son un cinturón de seguridad para la _conducta_ del
...
Tampoco cubre esto: `ALLOWED_TOOLS` deniega la _llamada_, no oculta la
herramienta del _listado_ que ve el modelo cada turno — ver
