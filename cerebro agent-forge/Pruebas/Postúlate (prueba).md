...
> solo miraba el _texto_ del error — un fallo que llegaba como código
...
> defecto: solo lo que coincide con `QUOTA_ERRORS` pausa y reintenta; _todo lo
> demás_ —incluido lo que no encaja en ningún patrón conocido— marca `fatal`
