...
- _"¿Los pagos se realizarán a través de la plataforma Stripe?"_
- _"¿Puede ser que un buen stack sea full Ruby on Rails? Es con el que se hizo
  Twitter en su día."_
...
- **Ruby on Rails**: rechazado por el [[Arquitecto]], con motivo explícito en
  `docs/01-ARCHITECTURE.md`: _"Rails no da tipado estático ni comparte tipos
  con el frontend"_ (criterio explícito de la arquitectura: TypeScript de
...
> run _actual_, así que las fases ya terminadas en ejecuciones anteriores se
